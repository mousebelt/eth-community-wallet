...
const Network = {
  ...
  // 'Ropsten Testnet': { rpc: 'https://ropsten.infura.io/GjiCzFxpQAUkPtDUpKEP', tx_explorer: 'https://nrl.explorer.com/ETH/transaction/%s?netType=test' },
  // 'Main Net': { rpc: 'https://mainnet.infura.io/GjiCzFxpQAUkPtDUpKEP', tx_explorer: 'https://nrl.explorer.com/ETH/transaction/%s' },
};
